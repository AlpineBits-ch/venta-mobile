...
/// signal to stop waiting on.
 String? get embedsJson;/// Discord-compatible message bitfield. Bit 2 (`4`) is
/// suppressed-embeds - see [hasSuppressedEmbeds].
 int get flags;/// When the **author** last changed the text, and the only thing that may
/// drive an "(edited)" marker. Null when never edited.
 DateTime? get editedAt;/// When the row was last written *by anyone or anything* - including a
...
/// second after it was posted, by nobody.
 DateTime? get updatedAt;/// Picks the wording variant for `MessageType.system`/`guildMemberJoin`/
...
@JsonKey(includeFromJson: false, includeToJson: false) bool get isBotCommandPlaceholder;/// Client-only: a bot reply only this user was sent, which the server never
...
@JsonKey(includeFromJson: false, includeToJson: false) bool get isEphemeral;/// Client-only: this message is ciphertext we hold no keys for.
///
...
@useResult
$Res call({
 String id, String content, String? conversationId, String? channelId, String authorId, DateTime? createdAt, bool isPending, bool isFailed, String? inReplyTo, List<String> mentions, List<String> roleMentions, bool mentionsEveryone, bool mentionsHere, List<AttachmentDto> attachments, List<MessageReactionDto> reactions, MessageEncryptionState encryptionState,@JsonKey(unknownEnumValue: MessageType.unknown) MessageType type,@JsonKey(unknownEnumValue: MessageAuthorType.standard) MessageAuthorType authorIdType, bool isPinned, DateTime? pinnedAt, String? pinnedById, String? embedsJson, int flags, DateTime? editedAt, DateTime? updatedAt, int? systemMessageVariant, int? mlsGeneration, int? mlsEpoch, String? senderDeviceId,@JsonKey(includeFromJson: false, includeToJson: false) bool isBotCommandPlaceholder,@JsonKey(includeFromJson: false, includeToJson: false) bool isEphemeral,@JsonKey(includeFromJson: false, includeToJson: false) bool isUndecryptable,@JsonKey(includeFromJson: false, includeToJson: false) bool isUnverifiedPlaintext
});
...
as String?,embedsJson: freezed == embedsJson ? _self.embedsJson : embedsJson // ignore: cast_nullable_to_non_nullable
...
as DateTime?,systemMessageVariant: freezed == systemMessageVariant ? _self.systemMessageVariant : systemMessageVariant // ignore: cast_nullable_to_non_nullable
...
as bool,isEphemeral: null == isEphemeral ? _self.isEphemeral : isEphemeral // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String content,  String? conversationId,  String? channelId,  String authorId,  DateTime? createdAt,  bool isPending,  bool isFailed,  String? inReplyTo,  List<String> mentions,  List<String> roleMentions,  bool mentionsEveryone,  bool mentionsHere,  List<AttachmentDto> attachments,  List<MessageReactionDto> reactions,  MessageEncryptionState encryptionState, @JsonKey(unknownEnumValue: MessageType.unknown)  MessageType type, @JsonKey(unknownEnumValue: MessageAuthorType.standard)  MessageAuthorType authorIdType,  bool isPinned,  DateTime? pinnedAt,  String? pinnedById,  String? embedsJson,  int flags,  DateTime? editedAt,  DateTime? updatedAt,  int? systemMessageVariant,  int? mlsGeneration,  int? mlsEpoch,  String? senderDeviceId, @JsonKey(includeFromJson: false, includeToJson: false)  bool isBotCommandPlaceholder, @JsonKey(includeFromJson: false, includeToJson: false)  bool isEphemeral, @JsonKey(includeFromJson: false, includeToJson: false)  bool isUndecryptable, @JsonKey(includeFromJson: false, includeToJson: false)  bool isUnverifiedPlaintext)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MessageDto() when $default != null:
return $default(_that.id,_that.content,_that.conversationId,_that.channelId,_that.authorId,_that.createdAt,_that.isPending,_that.isFailed,_that.inReplyTo,_that.mentions,_that.roleMentions,_that.mentionsEveryone,_that.mentionsHere,_that.attachments,_that.reactions,_that.encryptionState,_that.type,_that.authorIdType,_that.isPinned,_that.pinnedAt,_that.pinnedById,_that.embedsJson,_that.flags,_that.editedAt,_that.updatedAt,_that.systemMessageVariant,_that.mlsGeneration,_that.mlsEpoch,_that.senderDeviceId,_that.isBotCommandPlaceholder,_that.isEphemeral,_that.isUndecryptable,_that.isUnverifiedPlaintext);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String content,  String? conversationId,  String? channelId,  String authorId,  DateTime? createdAt,  bool isPending,  bool isFailed,  String? inReplyTo,  List<String> mentions,  List<String> roleMentions,  bool mentionsEveryone,  bool mentionsHere,  List<AttachmentDto> attachments,  List<MessageReactionDto> reactions,  MessageEncryptionState encryptionState, @JsonKey(unknownEnumValue: MessageType.unknown)  MessageType type, @JsonKey(unknownEnumValue: MessageAuthorType.standard)  MessageAuthorType authorIdType,  bool isPinned,  DateTime? pinnedAt,  String? pinnedById,  String? embedsJson,  int flags,  DateTime? editedAt,  DateTime? updatedAt,  int? systemMessageVariant,  int? mlsGeneration,  int? mlsEpoch,  String? senderDeviceId, @JsonKey(includeFromJson: false, includeToJson: false)  bool isBotCommandPlaceholder, @JsonKey(includeFromJson: false, includeToJson: false)  bool isEphemeral, @JsonKey(includeFromJson: false, includeToJson: false)  bool isUndecryptable, @JsonKey(includeFromJson: false, includeToJson: false)  bool isUnverifiedPlaintext)  $default,) {final _that = this;
switch (_that) {
case _MessageDto():
return $default(_that.id,_that.content,_that.conversationId,_that.channelId,_that.authorId,_that.createdAt,_that.isPending,_that.isFailed,_that.inReplyTo,_that.mentions,_that.roleMentions,_that.mentionsEveryone,_that.mentionsHere,_that.attachments,_that.reactions,_that.encryptionState,_that.type,_that.authorIdType,_that.isPinned,_that.pinnedAt,_that.pinnedById,_that.embedsJson,_that.flags,_that.editedAt,_that.updatedAt,_that.systemMessageVariant,_that.mlsGeneration,_that.mlsEpoch,_that.senderDeviceId,_that.isBotCommandPlaceholder,_that.isEphemeral,_that.isUndecryptable,_that.isUnverifiedPlaintext);}
}
...
class _MessageDto implements MessageDto {
  const _MessageDto({required this.id, required this.content, this.conversationId, this.channelId, required this.authorId, this.createdAt, this.isPending = false, this.isFailed = false, this.inReplyTo, final  List<String> mentions = const <String>[], final  List<String> roleMentions = const <String>[], this.mentionsEveryone = false, this.mentionsHere = false, final  List<AttachmentDto> attachments = const <AttachmentDto>[], final  List<MessageReactionDto> reactions = const <MessageReactionDto>[], this.encryptionState = MessageEncryptionState.plain, @JsonKey(unknownEnumValue: MessageType.unknown) this.type = MessageType.message, @JsonKey(unknownEnumValue: MessageAuthorType.standard) this.authorIdType = MessageAuthorType.standard, this.isPinned = false, this.pinnedAt, this.pinnedById, this.embedsJson, this.flags = 0, this.editedAt, this.updatedAt, this.systemMessageVariant, this.mlsGeneration, this.mlsEpoch, this.senderDeviceId, @JsonKey(includeFromJson: false, includeToJson: false) this.isBotCommandPlaceholder = false, @JsonKey(includeFromJson: false, includeToJson: false) this.isEphemeral = false, @JsonKey(includeFromJson: false, includeToJson: false) this.isUndecryptable = false, @JsonKey(includeFromJson: false, includeToJson: false) this.isUnverifiedPlaintext = false}): _mentions = mentions,_roleMentions = roleMentions,_attachments = attachments,_reactions = reactions;
...
@override@JsonKey(unknownEnumValue: MessageType.unknown) final  MessageType type;
...
/// 404. It is also not a candidate for the read marker, for the same
/// reason - `MessageThreadBloc` skips it there.
@override@JsonKey(includeFromJson: false, includeToJson: false) final  bool isEphemeral;
