...
/// or the list line is bought/cleared.
 DateTime? get restockedAt; String get addedByUserId;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,channelId,name,quantity,unit,lowThreshold,expiresAt,isLow,restockedAt,addedByUserId);

@override
String toString() {
  return 'PantryItemDto(id: $id, channelId: $channelId, name: $name, quantity: $quantity, unit: $unit, lowThreshold: $lowThreshold, expiresAt: $expiresAt, isLow: $isLow, restockedAt: $restockedAt, addedByUserId: $addedByUserId)';
}
...
@useResult
$Res call({
 String id, String channelId, String name, double quantity, String? unit, double? lowThreshold, DateTime? expiresAt, bool isLow, DateTime? restockedAt, String addedByUserId
});
...
/// Create a copy of PantryItemDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? channelId = null,Object? name = null,Object? quantity = null,Object? unit = freezed,Object? lowThreshold = freezed,Object? expiresAt = freezed,Object? isLow = null,Object? restockedAt = freezed,Object? addedByUserId = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String channelId,  String name,  double quantity,  String? unit,  double? lowThreshold,  DateTime? expiresAt,  bool isLow,  DateTime? restockedAt,  String addedByUserId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PantryItemDto() when $default != null:
return $default(_that.id,_that.channelId,_that.name,_that.quantity,_that.unit,_that.lowThreshold,_that.expiresAt,_that.isLow,_that.restockedAt,_that.addedByUserId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String channelId,  String name,  double quantity,  String? unit,  double? lowThreshold,  DateTime? expiresAt,  bool isLow,  DateTime? restockedAt,  String addedByUserId)  $default,) {final _that = this;
switch (_that) {
case _PantryItemDto():
return $default(_that.id,_that.channelId,_that.name,_that.quantity,_that.unit,_that.lowThreshold,_that.expiresAt,_that.isLow,_that.restockedAt,_that.addedByUserId);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String channelId,  String name,  double quantity,  String? unit,  double? lowThreshold,  DateTime? expiresAt,  bool isLow,  DateTime? restockedAt,  String addedByUserId)?  $default,) {final _that = this;
switch (_that) {
case _PantryItemDto() when $default != null:
return $default(_that.id,_that.channelId,_that.name,_that.quantity,_that.unit,_that.lowThreshold,_that.expiresAt,_that.isLow,_that.restockedAt,_that.addedByUserId);case _:
  return null;
...
/// Create a copy of PantryItemDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? channelId = null,Object? name = null,Object? quantity = null,Object? unit = freezed,Object? lowThreshold = freezed,Object? expiresAt = freezed,Object? isLow = null,Object? restockedAt = freezed,Object? addedByUserId = null,}) {
